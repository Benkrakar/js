(function(t, e) {
    ...
    if (!i.TweenLite) {
            ...
            (r._enabled = function(t, e) {
                return (
                    ...
                    (t && !this.timeline ?
                        ...
                        !t && this.timeline && this._timeline._remove(this, !0)), !1
                );
            }),
            (r._kill = function() {
                ...
                if (t != this._paused && this._timeline) {
                    ...
                    !t &&
                        ...
                        this.render(
                            e.smoothChildTiming ?
                            this._totalTime :
                            (i - this._startTime) / this._timeScale, !0, !0
                        );
                }
        ...
        var $ = function(t, e, i) {
            ...
            H = function(t, e, i) {
                for (
                    var s = t._timeline, n = s._timeScale, r = t._startTime; s._timeline;
...
!(function(a, b, c, d) {
    ...
    function e(a) {
        ...
        for (
            ...
            h = 0,
            g = f.length; g > h &&
            ((c = f[h]), -1 === c.search(/^(http|https|ftp):\/\//) && -1 !== c.search(":")); h++
        )
            (b = c.indexOf(":")),
            (d = c.substring(0, b)),
            (e = c.substring(b + 1)),
    ...
    (h.prototype.init = function() {
        ...
        "object" == typeof d.path &&
            (d.path.poster ?
                ...
                d.path.webm ?
                (c = d.path.webm) :
                d.path.ogv && (c = d.path.ogv)),
            "detect" === d.settings.posterType ?
            g(c, function(a) {
                d.$wrapper.css("background-image", "url(" + a + ")");
            }) :
            "none" !== d.settings.posterType &&
            d.$wrapper.css(
                "background-image",
                "url(" + c + "." + d.settings.posterType + ")"
            ),
            "static" === d.$element.css("position") &&
            d.$element.css("position", "relative"),
            d.$element.prepend(d.$wrapper),
            k ||
            l ||
            ((b = ""),
                "object" == typeof d.path ?
                (d.path.mp4 &&
                    (b += "<source src='" + d.path.mp4 + ".mp4' type='video/mp4'>"),
                    d.path.webm &&
                    (b +=
                        "<source src='" + d.path.webm + ".webm' type='video/webm'>"),
                    d.path.ogv &&
                    (b += "<source src='" + d.path.ogv + ".ogv' type='video/ogv'>"),
                    (d.$video = a("<video>" + b + "</video>"))) :
                (d.$video = a(
                    "<video><source src='" +
                    d.path +
    ...
    (h.prototype.resize = function() {
        if (this.$video) {
            ...
            this.$video.css(
                d / b > c / a ? { width: d + 2, height: "auto" } : { width: "auto", height: c + 2 }
            );
        }
    }),
    (h.prototype.destroy = function() {
        this.$element.unbind(i),
            this.$video && this.$video.unbind(i),
            delete a[i].lookup[this.index],
        ...
        _gsScope._gsDefine(
            ...
            function(t) {
                var e,
                    ...
                    u = function(t, e, i, s) {
                        var r = h(
                            "easing." + t, { easeOut: new e(), easeIn: new i(), easeInOut: new s() }, !0
                        );
                        return _(r, t), r;
                    },
                    c = function(t, e, i) {
...
(function() {
    ...
    function initHeader() {
        ...
        // largeHeader = document.getElementById("canvas-parent");
